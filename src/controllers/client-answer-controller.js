...
export const clientAnswerController = {
  index: {
    handler: async function (request, h) {
      ...
      return h.view("client-answers-view", viewData);
    },
  },
  ...
  addAnswer: {
    validate: {
      ...
      failAction: function (request, h, error) {
        return h.view("client-answers-view", { title: "Add Answer error", errors: error.details }).takeover().code(400);
      },
    },
    handler: async function (request, h) {
      const loggedInUser = request.auth.credentials;
      ...
      return h.redirect(`/clientnotice/${discussion.noticeid}/clientanswers/${discussion._id}`); 
    },
  },
